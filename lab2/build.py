...
includeDirs += ["-I","../../../machines/cortex/armv7em/stm32f407/STM32F4xx_StdPeriph_Driver/inc"]
includeDirs += ["-I","../../../machines/cortex/armv7em/stm32f407/STM32F4xx_StdPeriph_Driver/src"]
...
cSourceList.append(projfile.ProjectFile("machines/cortex/armv7em/stm32f407/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_gpio.c", trampoline_base_path))
cSourceList.append(projfile.ProjectFile("machines/cortex/armv7em/stm32f407/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rcc.c", trampoline_base_path))
cSourceList.append(projfile.ProjectFile("machines/cortex/armv7em/stm32f407/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_exti.c", trampoline_base_path))
cSourceList.append(projfile.ProjectFile("machines/cortex/armv7em/stm32f407/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_syscfg.c", trampoline_base_path))
cSourceList.append(projfile.ProjectFile("machines/cortex/armv7em/stm32f407/STM32F4xx_StdPeriph_Driver/src/misc.c", trampoline_base_path))
...
if make.errorCount() == 0:
  if askedGoal == "burn" :
    if makefile.find_executable("st-flash") != None:
      subprocess.call('st-flash write lab2_exe.bin 0x8000000 ',shell=True)
    else:
